...
public class BOJ_1010 {
    ...
    public void inputSite() throws IOException {

        for (int i=0;i<testNum;i++) {
            String text = br.readLine();
            String[] site = text.split(" ");
            westSite = Integer.parseInt(site[0]);
            eastSite = Integer.parseInt(site[1]);
            edge();
        }
    }
    ...
    public void edge() {
        ...
        System.out.println(dp[eastSite][westSite]);
    }

    public static void main(String[] args) throws IOException {
        BOJ_1010 boj1010 = new BOJ_1010();
        boj1010.inputTestNum();
        boj1010.inputSite();
    }
}